...
public abstract class Game
{
    ...
    public void incrementLizards()
    {
        lizards ++;
    }
    
     public int getSpocks()
    {
        return spocks;
    }
    
    public void incrementSpocks()
    {
        spocks ++;
    }
    ...
    {
        int winner = p1Move.moveComparrison(p2Move);
        switch (winner)
        {
            case 0: 
                incrementDraws();
